...
export default function LangToggle() {
  ...
  return (
    <button
      ...
      title={`lang ${next}`}
      className="shrink-0 rounded-sm px-1 font-mono text-[11px] font-bold uppercase leading-none tracking-[0.1em] text-fg/70 transition-colors hover:text-fg focus-visible:outline focus-visible:outline-1 focus-visible:outline-fg/60"
    >
