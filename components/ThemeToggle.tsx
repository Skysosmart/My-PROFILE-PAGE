...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      title={`theme ${next}`}
      className="shrink-0 rounded-sm px-1 font-mono text-[13px] leading-none text-fg/70 transition-colors hover:text-fg focus-visible:outline-solid focus-visible:outline-1 focus-visible:outline-fg/60"
    >
