...
export const projects: Project[] = [
  ...
  },
  {
    ...
    status: 'Completed',
    description:
      'An Agoda-style booking platform built for the CODEKIT qualifier round at the Thailand Robot & Coding Challenge 2026. I owned the frontend - landing page, responsive layout across screen sizes, and the navigation tying every page together. It carried the team into the finals.',
    tags: ['Frontend', 'UI Design', 'Responsive', 'Qualifier'],
    image: '/projects/tgoda.jpg',
    contribution: 'CODEKIT qualifier \u00b7 15 of 53 commits across 3 contributors',
  ...
  },
  {
    ...
    status: 'Completed',
    description:
      'A Discord-style chat app built for the CODEKIT finals. I built the landing page, the sign-up and login flow, and more than twenty core functions - taking a large platform apart and rebuilding it into something that actually works. 3rd place nationally.',
    tags: ['Frontend', 'Auth Flow', 'Web App', '3rd Place'],
    image: '/projects/nexus.jpg',
    contribution: 'CODEKIT finals, 3rd place \u00b7 most commits of the three: 38 of 97',
  ...
  },
  {
    ...
    status: 'Completed',
    description:
      'A Chrome MV3 extension for Thailand\u2019s TCAS portfolio system, built as a companion to the Doodee Future platform. It keeps a local vault of achievements and certificate photos, autofills the TCASFolio forms block by block, and can send the vault to the platform for a portfolio analysis. The data never leaves the machine unless you ask it to.',
